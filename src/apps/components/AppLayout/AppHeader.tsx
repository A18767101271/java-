    ...
    render() {
        return (<div className={classNames("app-header", this.props.className)}>
            <div className="app-header-left">
                ...
                {this.props.addIsShow ? <a href="javascript:;" className={"add-btn"} onClick={() => { window.location.href = '#/' + this.props.addUrl + '?mchid=' + shopId }}></a> : undefined}
                {this.props.editIsShow ? <a href="javascript:;" className={"edit-btn"} onClick={() => { window.location.href = '#/editconfig?cardid=' + this.props.cardId + '?mchid=' + shopId }}>编辑</a> : undefined}
            </div>
