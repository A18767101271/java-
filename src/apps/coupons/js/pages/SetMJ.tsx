            ...
            <Layout>
                ...
                <Content>
                    <div className="wrap" data-page='setmj'>
                        ...
                        <div className='row'>
                            <div className='left fl'>最低可用金额</div>
                            <div className="right fr"><input type="text" placeholder="请输入最低可用面额" className="name-input" value={this.state.userPrice || ''}
                                onChange={e => {
                                    let result = re.test(e.target.value);
                                    if (result || !e.target.value) this.setState({ userPrice: e.target.value });
                                }} /></div>
                        </div>
