...
function ZKFn(data: any) {
    ...
    h += `<div class="part1 clearfix">
        ...
        <div class="line">
            ...
            <div class="right">`+ data2[0].productName + `</div>
        </div>`

    if (data2[0].productActType == '按折扣价') {
        h += `<div class="line">
            <div class="left">折扣范围：</div>
            <div class="right">`+ data2[0].discountScope + `折</div>
        </div>
        <div class="line">
        <div class="left">折后价格：</div>
        <div class="right">`+ data2[0].discountPrice / 100 + `元</div>
        </div>`
    }
    else {
        h += ` <div class="line">
        <div class="left">活动价格：</div>
        <div class="right">`+ data2[0].activityPrice / 100 + `元</div>
        </div>`
    }

    h += `<div class="line">
            <div class="left">每单限购：</div>
            <div class="right">`+ data2[0].limitNum + `</div>
        </div>
        <div class="line">
