...
import { DatePicker, Picker, Switch } from 'antd-mobile';
    ...
    mainRender() {
        return <div className='wrap' data-page='setzhekou' >
            ...
            <div className="l-label clearfix" onClick={() => this.setState({ chooseFoods: true })}>
                ...
                <div className="right fr"><span className="span-goods">{this.state.selected && this.state.selected.length > 0 ? '已设置' : '请选择商品'}</span><i></i></div>
            </div>
            ...
            {this.state.productActType == '按活动价' ? <div className="l-label">
                ...
                <div className="right fr">
                    <input type="text" className="num-input" placeholder="在此输入数量，默认不限" value={this.state.activityPrice || ''} onChange={e => this.setState({ activityPrice: parseInt(e.target.value) })} />
                </div>
            </div> :
                <div>
                    <div className="l-label">
                        ...
                        <div className="right fr">
                            <input type="text" className="num-input" placeholder="在此输入数量，默认不限" value={this.state.discountScope || ''} onChange={e => this.setState({ discountScope: parseInt(e.target.value) })} />
                        </div>
                    </div>
                    <div className="l-label">
                        <div className="left fl">折后价格</div>
                        <div className="right fr">
                            <input type="text" className="num-input" placeholder="在此输入数量，默认不限" value={this.state.discountPrice || ''} onChange={e => this.setState({ discountPrice: parseInt(e.target.value) })} />
                        </div>
                    </div>
                </div>
            }
            ...
            <button className={classNames("btn-yes", { 'dis': this.state.agree })} disabled={!this.state.agree}>保存</button>
        </div >
    }
